...
public class Veiculo {
    ...
    public Veiculo(int id, String placa, String locador, Double valorloc, String iniciocont, String fimcont, String unidade, String modelo, String tipo, String classificacao, String empresa, String ccsoja, String cartao, String condutor, String ccmilho, String devolvido) {
        this.id = id;
        this.placa = placa;
    ...
    public String getIniciocont() {
        return iniciocont;
    }

    public void setIniciocont(String iniciocont) {
        this.iniciocont = iniciocont;
    }

    public String getFimcont() {
        return fimcont;
    }

    public void setFimcont(String fimcont) {
        this.fimcont = fimcont;
    }
